    ...
    Calendar.prototype.fn = function () {
        ...
        function clickActive (binder, o) {
            ...
            binder.addEventListener('click', function (e) {
                ...
                var day = document.getElementsByClassName('active1');

                if(day.length != 0){
                    day[0].classList.remove('active1');
                }

                if (Number(binder.innerText) % 2 === 0){
                    ...
                    $("button[data-label = 'record_cody']").css("display", "none")
                }

                binder.parentNode.classList.add('active1');
